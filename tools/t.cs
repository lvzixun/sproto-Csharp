...
namespace SprotoType{ 
	public class Person : SprotoTypeBase {
		...
		private List<Test> _aa; // tag 5
		public List<Test> aa {
			get { return _aa; }
			set { base.has_field.set_field (4, true); _aa = value; }
		}
		public bool HasAa {
		...
		protected override void decode () {
			...
			while (-1 != (tag = base.deserialize.read_tag ())) {
				...
				case 3:
					...
					break;
				case 5:
					this.aa = base.deserialize.read_obj_list<Test> ();
					break;
				default:
					base.deserialize.read_unknow_data ();
					break;
		...
		public override int encode (SprotoStream stream) {
			...
			if (base.has_field.has_field (4)) {
				base.serialize.write_obj (this.aa, 5);
			}
...
namespace Protocol{ 
	public class SprotoTypeDefault {
		...
		static SprotoTypeDefault() {
			...
			Protocol.SetRequest<SprotoTypeDefaultType.foobar.request> (foobar.Tag);
			Protocol.SetResponse<SprotoTypeDefaultType.foobar.response> (foobar.Tag);
